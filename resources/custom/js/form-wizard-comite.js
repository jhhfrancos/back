var FormWizard = function () {
    ...
    return {
        ...
        init: function () {
			...
			var formTotal1 = $('#form_wizard_1');
            var formTotal = $('#form_wizard_2');
            ...
            var handleTitle = function(tab, navigation, index) {
				...
				jQuery('li', formTotal1).removeClass("done");
            ...
            formTotal1.bootstrapWizard({
                ...
                onTabShow: function (tab, navigation, index) {
                    ...
                    var current = index + 1;
                    var $percent = (current / total) * 100;
                    formTotal1.find('.progress-bar').css({
                        width: $percent + '%'
                    });
                }
            });

            formTotal1.find('.button-previous').hide();
            formTotal1.find('.button-submit').click(function () {
                var divDate = document.getElementById("fechaCreacion");
                divDate.valueAsDate=new Date();
            }).hide();
