...
function cargarVelocimetros(idDiv, value) {
        ...
        */
        ...
        // Create SVG element
        svg = el.append('svg').attr('width', width).attr('height', height).attr('style', "margin-bottom: " + (- height/2 + 10) + ";");
